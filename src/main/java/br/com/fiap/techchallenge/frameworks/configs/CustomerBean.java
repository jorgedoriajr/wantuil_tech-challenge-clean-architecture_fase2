...
public class CustomerBean {
    ...
    @Bean
    CreateCustomerWeb customerCreateController(final CreateCustomer customerCreate,
                                               final CustomerRequestToCustomer customerRequestToCustomer,
                                               final CustomerToCustomerResponse customerToCustomerResponse) {
        return new CreateCustomerController(customerCreate, customerRequestToCustomer, customerToCustomerResponse);
    }
    ...
    @Bean
    FindCustomerByCpfWeb customerFindByCpfController(final FindCustomerByCpf customerFindByCpf,
                                                     final CustomerToCustomerResponse customerToCustomerResponse) {
        return new FindCustomerByCpfController(customerFindByCpf, customerToCustomerResponse);
    }
